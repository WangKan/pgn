...
{
	NavMesh* mesh  = (NavMesh*)(navMesh->core());
	float* pVertices = (float*)mesh->vertexBuffer;
	unsigned short* pIndices = (unsigned short*)mesh->indexBuffer;
	unsigned short* pAdjacentNodes = (unsigned short*)mesh->adjacentNodes;
	...
	int maxFaceCount = mesh->numIndices / 3;
